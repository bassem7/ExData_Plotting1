...
#       Add the PNG file and R code file o the top-level folder of your git repository (no need for separate sub-folders)
...
#Plot 2: Global Active Power (kilowatts) vs "Time/Day of the Week" main="". col =""
par(mfrow = c(1,1))
